        ...
        <div className={`rounded-md border p-4 ${classes.container} ${className}`}>
            <div className="flex">
                ...
                <div className="ml-3 flex-1">
                    ...
                    <div className={`text-sm ${title ? 'mt-1' : ''} ${classes.content}`}>
                        {children}
                    </div>
                </div>
                {onClose && (
                    <div className="ml-auto pl-3">
                        <div className="-mx-1.5 -my-1.5">
                            <button
                                type="button"
                                className={`inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2 ${classes.icon} hover:opacity-75`}
                                onClick={onClose}
                            >
