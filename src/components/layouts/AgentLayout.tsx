                ...
                <aside className="w-64 bg-white shadow-lg min-h-screen">
                    <nav className="mt-8">
                        <div className="px-4 space-y-2">
                            ...
                            <Link
                                to="/agent/projects"
                                className={`flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors ${location.pathname === '/agent/projects'
                                        ? 'bg-warning-100 text-warning-700'
                                        : 'text-secondary-600 hover:bg-secondary-100 hover:text-secondary-900'
                                    }`}
                            >
                            ...
                            <Link
                                to="/agent/settings"
                                className={`flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors ${location.pathname === '/agent/settings'
                                        ? 'bg-warning-100 text-warning-700'
                                        : 'text-secondary-600 hover:bg-secondary-100 hover:text-secondary-900'
                                    }`}
                            >
