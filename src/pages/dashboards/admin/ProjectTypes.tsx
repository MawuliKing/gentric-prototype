...
export const ProjectTypes: React.FC = () => {
  ...
  const [newProjectType, setNewProjectType] =
    useState<CreateProjectTypeRequest>({
      name: "",
      description: "",
    });

  const [editProjectType, setEditProjectType] =
    useState<UpdateProjectTypeRequest>({
      name: "",
      description: "",
    });
    ...
    <div className="space-y-6">
      ...
      >
        <ModalBody>
          <div className="space-y-4">
            <Input
              ...
              onChange={(e) =>
                setNewProjectType({ ...newProjectType, name: e.target.value })
              }
              error={errors.name}
              required
              disabled={isCreating}
        ...
        <ModalFooter>
          ...
          <Button variant="primary" onClick={handleAdd} disabled={isCreating}>
            {isCreating ? (
              <>
                <svg
        ...
        <ModalBody>
          <div className="space-y-4">
            <Input
              ...
              onChange={(e) =>
                setEditProjectType({ ...editProjectType, name: e.target.value })
              }
